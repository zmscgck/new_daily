...
class Entry(models.Model):
    ...
    company = models.ForeignKey(Group, on_delete=models.CASCADE, verbose_name='单位名称',default=1)
    owner = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='管理员',default=1)
